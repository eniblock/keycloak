<#macro registrationLayout bodyClass="" displayInfo=false displayMessage=true>
    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Chivo:300,400,600,700" rel="stylesheet">
    ...
    <div id="kc-container" class="${properties.kcContainerClass! 'kc-container-'+properties.kcCssColor!}">
        <div id="kc-container-wrapper-${properties.kcCssMode!}" class="${properties.kcContainerWrapperClass!}">

            <img src="${url.resourcesPath}/${properties.kcLogoUrl}" alt="collaborate" class="kc-logo">

            <div id="kc-content" class="${properties.kcContentClass! 'kc-content-'+properties.kcCssColor!}">
            ...
            <#--                                    </#list>-->
            <#--                                </select>-->
            <#--                                &lt;#&ndash;  <label class="mdc-floating-label mdc-floating-label--float-above">Language!</label>  &ndash;&gt;-->
